  ...
  try {
    ...
    for (let i = 0; i < menuItems.length; i++){
      ...
      for (let j = 0; j < inventoryItemsForMenuItems.length; j++){
        let updateInventoryItem = await pool.query("UPDATE inventory_item SET inventory_item_quantity = inventory_item_quantity - %d WHERE inventory_id = %d",vector1.get(i), vector2.get(i);
      }
